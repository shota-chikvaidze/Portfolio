  ...
  return (
    <>
          ...
          >
            <div className='flex justify-center sm:justify-start'>
              <img 
                src={homeMain} 
                alt='Home image' 
                className='w-[80%] sm:w-[300px] h-auto  border-4 border-[var(--bg-secondary)] object-cover md:w-[210px] md:h-auto rounded-full transition-shadow duration-300' 
              />
            </div>
          </motion.div>
      ...
      <section id='tech' className='w-full h-auto my-20 flex justify-center '>
        <div className='max-w-6xl w-full px-4'>
            ...
            <motion.h2 
              ...
              className='text-4xl sm:text-5xl font-[700] mb-6 tracking-tight text-[var(--text-white)]'>
              Tech Stack
            </motion.h2>
      ...
      <section id='about' className='w-full py-20 flex justify-center px-4'>
        <div className='w-full max-w-6xl px-1 sm:px-4 space-y-6'>
